...
set.seed(123)
treatment_months <- sample(1:12,4,replace=FALSE)
data$treatment <- ifelse(data$numeric_MOC2 %in% treatment_months,1,0)
...
#print(xtable(IPW_df, type = "latex"), file = "IPW_table_sensitivity.tex")
...
#print(xtable(matching_df_new, type = "latex"), file = "matching_table_sensitivity.tex")